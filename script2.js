//Varun Dewan 2019
//alert('file uploded sucessufllu')
var $ = {
  ...
  const details = () => {
    let a = {};
    for (let i in myDrop.selected) {
      a[i] = myDrop.options[myDrop.selected[i].index].html;
    }
    alert("data has been sent to all API's successfully")
    eel.selected_apis(a)
  };
